...
public class IA_ManagerTest {
	...
	public void AtacarPorAlDespierto() {
		...
		assertEquals("PUEDO ATACARLO//PUEDE ATACARME//VER DESPIERTOS//GANO DESPIERTOS: 1.0",
	...
	public void AtacadoPorMasArmas() {
		...
		assertEquals("PUEDO ATACARLO//PUEDE ATACARME//VER DESPIERTOS//MAS ARMAS//GANO MAS ARMAS:2.0",
				attackedPositionIA.getReason());
		assertEquals(1, attackedPositionIA.getCards().size());
	...
	public void AtacadoPorMasFlancos() {
		...
		IA_Manager manager = new IA_Manager(gameTable);
		InfoAction attackedPositionIA = manager.whoKill(converter.toCharacterArray(playerChairs2), playerB, R, 2);
		assertEquals("PUEDO ATACARLO//PUEDE ATACARME//VER DESPIERTOS//MAS ARMAS//MAS FLANCOS//GANO FLANCOS:2.0",
				attackedPositionIA.getReason());
		assertEquals(1, attackedPositionIA.getCards().size());
		assertTrue(attackedPositionIA.getCards().get(0) instanceof GunCard);
		GunCard gunCard = (GunCard) attackedPositionIA.getCards().get(0);
	...
	public void mejorArma() {
		...
		InfoAction attackedPositionIA = manager.whoKill(converter.toCharacterArray(playerChairs), playerB, R, 2);
		assertEquals(
				"PUEDO ATACARLO//PUEDE ATACARME//VER DESPIERTOS//MAS ARMAS//MAS FLANCOS//MEJOR ARMA//GANO MEJOR ARMA",
				attackedPositionIA.getReason());
		assertEquals(1, attackedPositionIA.getCards().size());
		assertTrue(attackedPositionIA.getCards().get(0) instanceof GunCard);
		GunCard gunCard = (GunCard) attackedPositionIA.getCards().get(0);
	...
	public void mejorArmaDifereciaVaso3Jugadores() {
		...
		assertEquals("PUEDO ATACARLO//PUEDE ATACARME//VER DESPIERTOS//MAS ARMAS//GANO MAS ARMAS:1.5",
				attackedPositionIA.getReason());
		assertEquals(2, attackedPositionIA.getCards().size());
		assertTrue(attackedPositionIA.getCards().get(0) instanceof KnifeCard);
	...
	public void MejorBusinessMIO() {
		...
		InfoAction attackedPositionIA = manager.whoKill(converter.toCharacterArray(playerChairs), playerB, R, 2);
		assertEquals(
				"PUEDO ATACARLO//PUEDE ATACARME//VER DESPIERTOS//MAS ARMAS//MAS FLANCOS//MEJOR ARMA//TENGO MAS ARMAS//MI MEJOR BUSINESS//GANO MI MEJOR BUSINESS",
				attackedPositionIA.getReason());
		assertEquals(2, attackedPositionIA.getCards().size());
		assertTrue(attackedPositionIA.getCards().get(0) instanceof KnifeCard);
		KnifeCard knifeCard = (KnifeCard) attackedPositionIA.getCards().get(0);
	...
	public void MejorBusinessSUYO() {
		...
		InfoAction attackedPositionIA = manager.whoKill(converter.toCharacterArray(playerChairs), playerB, R, 2);
		assertEquals(
				"PUEDO ATACARLO//PUEDE ATACARME//VER DESPIERTOS//MAS ARMAS//MAS FLANCOS//MEJOR ARMA//TENGO MAS ARMAS//MI MEJOR BUSINESS//SU MEJOR BUSINESS//GANO SU MEJOR BUSINESS",
				attackedPositionIA.getReason());
		assertEquals(2, attackedPositionIA.getCards().size());
		assertTrue(attackedPositionIA.getCards().get(0) instanceof KnifeCard);
		KnifeCard knifeCard = (KnifeCard) attackedPositionIA.getCards().get(0);
	...
	public void AlQueSea2JugadoresMeAtacaAPoderoso() {
		...
		InfoAction attackedPositionIA = manager.whoKill(converter.toCharacterArray(playerChairs), playerB, R, 2);
		assertEquals(
				"PUEDO ATACARLO//PUEDE ATACARME//VER DESPIERTOS//MAS ARMAS//MAS FLANCOS//MEJOR ARMA//TENGO MAS ARMAS//GANO TENGO MAS ARMAS:2.0",
				attackedPositionIA.getReason());
		assertEquals(1, attackedPositionIA.getCards().size());
		assertTrue(attackedPositionIA.getCards().get(0) instanceof GunCard);
	}
	...
	public void AlQueSea2Jugadores() {
		...
		InfoAction attackedPositionIA = manager.whoKill(converter.toCharacterArray(playerChairs), playerB, R, 2);
		assertEquals(
				"PUEDO ATACARLO//PUEDE ATACARME//VER DESPIERTOS//MAS ARMAS//MAS FLANCOS//MEJOR ARMA//TENGO MAS ARMAS//MI MEJOR BUSINESS//SU MEJOR BUSINESS//EL QUE SEA, < 3 JUGADORES",
				attackedPositionIA.getReason());
		assertEquals(2, attackedPositionIA.getCards().size());
		assertTrue(attackedPositionIA.getCards().get(0) instanceof KnifeCard);
		assertTrue(attackedPositionIA.getCards().get(1) instanceof GunCard);
	...
	public void AlQueSea3Jugadores() {
		...
		InfoAction attackedPositionIA = manager.whoKill(converter.toCharacterArray(playerChairs), playerB, R, 3);
		assertEquals(
				"PUEDO ATACARLO//PUEDE ATACARME//VER DESPIERTOS//MAS ARMAS//MAS FLANCOS//MEJOR ARMA//TENGO MAS ARMAS//MI MEJOR BUSINESS//SU MEJOR BUSINESS//GANO MAS PERSONAJES:10",
				attackedPositionIA.getReason());
		assertEquals(1, attackedPositionIA.getCards().size());
		assertTrue(attackedPositionIA.getCards().get(0) instanceof GunCard);
		GunCard gunCard = (GunCard) attackedPositionIA.getCards().get(0);
	...
	public void nadieMeAtacaMasArmas() {
		...
		IA_Manager manager = new IA_Manager(gameTable);
		InfoAction attackedPositionIA = manager.whoKill(converter.toCharacterArray(playerChairs2), playerB, R, 2);
		assertEquals("PUEDO ATACARLO//NO ME ATACA//VER DESPIERTOS//MAS ARMAS//GANO MAS ARMAS:1.0", attackedPositionIA.getReason());
		assertEquals(1, attackedPositionIA.getCards().size());
		assertTrue(attackedPositionIA.getCards().get(0) instanceof GunCard);
		GunCard gunCard = (GunCard) attackedPositionIA.getCards().get(0);
	...
	public void nadieMeAtacaMejorArma() {
		...
		IA_Manager manager = new IA_Manager(gameTable);
		InfoAction attackedPositionIA = manager.whoKill(converter.toCharacterArray(playerChairs2), playerB, R, 2);
		assertEquals("PUEDO ATACARLO//NO ME ATACA//VER DESPIERTOS//MAS ARMAS//MEJOR ARMA//GANO MEJOR ARMA",
				attackedPositionIA.getReason());
		assertEquals(1, attackedPositionIA.getCards().size());
		assertTrue(attackedPositionIA.getCards().get(0) instanceof GunCard);
		GunCard gunCard = (GunCard) attackedPositionIA.getCards().get(0);
	...
	public void nadieMeAtacaMejorBusiness() {
		...
		IA_Manager manager = new IA_Manager(gameTable);
		InfoAction attackedPositionIA = manager.whoKill(converter.toCharacterArray(playerChairs2), playerB, R, 2);
		assertEquals("PUEDO ATACARLO//NO ME ATACA//VER DESPIERTOS//MAS ARMAS//MEJOR ARMA//SU MEJOR BUSINESS//GANO SU MEJOR BUSINESS",
				attackedPositionIA.getReason());
		assertEquals(1, attackedPositionIA.getCards().size());
		assertTrue(attackedPositionIA.getCards().get(0) instanceof KnifeCard);
		KnifeCard knifeCard = (KnifeCard) attackedPositionIA.getCards().get(0);
	...
	public void nadieMeAtaca2JugadoresElQueSea() {
		...
		IA_Manager manager = new IA_Manager(gameTable);
		InfoAction attackedPositionIA = manager.whoKill(converter.toCharacterArray(playerChairs2), playerB, R, 2);
		assertEquals("PUEDO ATACARLO//NO ME ATACA//VER DESPIERTOS//MAS ARMAS//MEJOR ARMA//SU MEJOR BUSINESS//EL QUE SEA, < 3 JUGADORES",
				attackedPositionIA.getReason());
		assertEquals(1, attackedPositionIA.getCards().size());
		assertTrue(attackedPositionIA.getCards().get(0) instanceof KnifeCard);
		KnifeCard knifeCard = (KnifeCard) attackedPositionIA.getCards().get(0);
	...
	public void nadieMeAtaca3JugadoresMasJugadores() {
		...
		assertEquals("PUEDO ATACARLO//NO ME ATACA//VER DESPIERTOS//MAS ARMAS//MEJOR ARMA//SU MEJOR BUSINESS//GANO MAS PERSONAJES:3",
				attackedPositionIA.getReason());
		assertEquals(1, attackedPositionIA.getCards().size());
		assertTrue(attackedPositionIA.getCards().get(0) instanceof GunCard);
		GunCard gunCard = (GunCard) attackedPositionIA.getCards().get(0);
